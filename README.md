...
**Nusrat Jahan Mahina** — overall architecture ,destination explorer, user system, create and find  groups,tracking groups , checklist, messaging, notifications,UI design

**Sanzida Afroz** — friends system, expense splitting, group history,UI design
